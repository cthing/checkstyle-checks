 ...
 */
public class MissingAnnotationsDaoImpl extends NamedParameterJdbcDaoSupport implements Dao {
    ...
    public MissingAnnotationsDaoImpl(final DataSource dataSource) {
