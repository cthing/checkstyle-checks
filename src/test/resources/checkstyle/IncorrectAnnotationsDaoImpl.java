...
public class IncorrectAnnotationsDaoImpl extends NamedParameterJdbcDaoSupport implements Dao {
    ...
    public IncorrectAnnotationsDaoImpl(final DataSource dataSource) {
